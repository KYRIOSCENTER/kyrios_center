...
$mpdf = new mPDF('A4', array(215,168));
$PDFContent = '
<html>
					<head>
						<style>
					...
					<body>
						...
						<table class="notas" style="margin-top: 5px;">
							  ...
							  <tr class="notas">
								<td class="notas" height="65px;" valign="top" align="justify">
									'.$rows["notatecnico"].' - <font color="#ff0000">ENTREGADO EL '.$rows["fechafin"].' </font>
								</td>
							  </tr>
						</table>
						<table class="otra">
							  <tr class="otra">
								<td class="otra" colspan="2"><b>T&eacute;cnico</b><center><br><br>_________________________________<br>'.$rows["tecnico"].'</center></td>
...
$mpdf = new mPDF('A4', array(215,140));
$PDFContent = '
<html>
					<head>
						<style>
