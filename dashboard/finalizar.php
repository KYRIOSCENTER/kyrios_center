            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Finalizar Orden</h4> </div>
                    <!-- /.col-lg-12 -->
                </div>
                <div class="row">
                    <div class="col-md-12">
								...
								echo'
								 <form action="finorden.php" method="post">
								  ...
								  <div class="form-group col-sm-6">
									...
									<input type="text" name="nomcliente" class="form-control" value="'.$fila[3].'" maxlength="70" required style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" readonly>
								  </div>
								  <div class="form-group col-sm-6">
									<label>Celular del Cliente</label>
									<input type="text" name="celcliente" class="form-control" value="'.$fila[4].'" maxlength="30" required style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" readonly>
								  </div>
								  <div class="form-group col-sm-4">
									<label>Equipo</label>
                  ...
                  <label>Otros</label>
								  ...
								  <div class="form-group">
									...
									<input type="hidden" name="nombre" value="'.$nombre.'">
									<input type="hidden" name="email" value="'.$email.'">
									<button class="btn btn-success" style="margin-left:16px;">Finalizar Orden de Trabajo</button>
								  </div>
								</form>
								';
								}
