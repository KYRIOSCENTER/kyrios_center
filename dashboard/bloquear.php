...
if(isset($_POST["nombre"])){ 
  ...
  if ($bloquea=="bloquea")
  {
	  $sql5= "UPDATE perfiles SET estado='INACTIVO' WHERE codigo='$codigo'";
	  $sql6=mysqli_query($conexion, $sql5);

  }
  else
  {
	  $sql5= "UPDATE perfiles SET estado='ACTIVO' WHERE codigo='$codigo'";
	  $sql6=mysqli_query($conexion, $sql5);
  }
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Bloquear Usuarios</h4> </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                <!-- ============================================================== -->
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
							...
							$sql1="SELECT * FROM perfiles ORDER BY codigo ASC";
							$sql2=mysqli_query($conexion, $sql1);
							...
							echo'
								 <tr>
									...
									<td>'.$fila[6].'</td>
									<td>
										<form role="search" class="app-search hidden-sm hidden-xs m-r-10" method="post" action="bloquear.php">
											<input type="hidden" name="codigo" value="'.$fila[0].'">
											<input type="hidden" name="nombre" value="'.$nombre.'">
											<input type="hidden" name="email" value="'.$email.'">
											<input type="hidden" name="bloquea" value="bloquea">
											<button class="btn btn-info"><i class="fa fa-ban"></i></button>
										</form>
									</td>
									<td>
										<form role="search" class="app-search hidden-sm hidden-xs m-r-10" method="post" action="bloquear.php">
											...
											<input type="hidden" name="nombre" value="'.$nombre.'">
											<input type="hidden" name="email" value="'.$email.'">
											<input type="hidden" name="bloquea" value="desbloquea">
