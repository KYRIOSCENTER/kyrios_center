...
if(isset($_POST["finorden"])){ 
  $fin= $_POST["finorden"];
  
$sql1="SELECT * FROM ordenes WHERE codigo='$norden'";
...
<html>
					...
					<body>
						<div style="">
						<img src="img/kyrios.jpg" width="75%">
						</div>
						...
						<table class="otra" style="margin-top: 2px;">
							  <tr class="otra">
								<td class="otra" colspan="2">
									<b>Fecha de Entrega: <font color="#0C36A4">'.$rows["fechafin"].' </font></b>
								</td>
								<td class="otra" colspan="2">
									<b>Valor: <font color="#0C36A4"> $ '.$rows["valor"].'</font></b>
								</td>
							  </tr>
					    </table>
						<table class="otra">
							  <tr class="otra">
								<td class="otra" colspan="2"><b>Técnico</b><center><br>_________________________________<br>'.$rows["tecnico"].'</center></td>
								<td class="otra" colspan="2" ><b>Cliente</b><center><br>_________________________________<br>'.$rows["nomcliente"].'</center></td>
							  </tr>
							  <tr class="">
...
$mpdf->Output('Orden Nº '.$norden.'.pdf', 'I');
