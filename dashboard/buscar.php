        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    <li>
                        <form role="search" class="app-search hidden-sm hidden-xs m-r-10" target="_blank" method="post" action="pdf.php">
                            <input type="text" placeholder="Buscar Remisi&oacute;n" class="form-control" name="n">&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div class="container-fluid">
                ...
                <label>Otros</label>
							  ...
							  <div class="form-group">
								<input type="hidden" name="nombre" value="'.$nombre.'">
								<input type="hidden" name="email" value="'.$email.'">
								<button class="btn btn-success">Crear Orden de Trabajo</button>
							  </div>
							</form>
							';
