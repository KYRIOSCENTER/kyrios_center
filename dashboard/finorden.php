...
if(isset($_POST["nombre"])){ 
  ...
  $email= $_POST["email"];
  $codigo= $_POST["orden"];
  $notatec= $_POST["notatecnico"];
  $estado= $_POST["estado"];
  $valor= $_POST["valor"];
   
  $insertar="UPDATE ordenes SET notatecnico = '$notatec', estado = '$estado', fechafin = '$fechasys', valor= '$valor' WHERE codigo = '$codigo'";
		...
		<div class="modal fade" id="mostrarmodal" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
		   <div class="modal-dialog">
			 ...
			 <div class="modal-body" style="text-align:center;">
					...
					Orden Nº '.$_POST["orden"].' <font color="66bb99"> Finalizada</font>.
					<br><br>
					<input type="hidden" value="'.$_POST["orden"].'" name="n">
                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                        <div class="white-box analytics-info">
                            <h3 class="box-title">Total Ordenes</h3>
                    ...
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                        <div class="white-box analytics-info">
                            <h3 class="box-title">Ordenes Finalizadas</h3>
                            <ul class="list-inline two-part">
                                <li>
                    ...
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                        <div class="white-box analytics-info">
                            <h3 class="box-title">Ordenes Pendientes</h3>
                            <ul class="list-inline two-part">
                                <li>
                                    <div id="sparklinedash3"></div>
                                </li>
                                <li class="text-right"><i class="ti-arrow-up text-warning"></i> <span class="counter text-info">
								<?php
