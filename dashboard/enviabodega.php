...
{
$sql8= "UPDATE ordenes SET estado='EN BODEGA' WHERE codigo='$norden'";
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Gestion de Bodega</h4> </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                <!-- ============================================================== -->
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            ...
                            <h3 class="box-title">Ordenes para Bodega</h3>
								...
								if ($diasfechas>=12)
								{
									echo'
										 <tr>
											...
											<td>
												<form role="search" class="app-search hidden-sm hidden-xs m-r-10" method="post" action="enviabodega.php">
													<input type="hidden" name="nombre" value="'.$nombre.'">
													<input type="hidden" name="email" value="'.$email.'">
													<input type="hidden" name="n" value="'.$fila[0].'">
													<button class="btn btn-danger"><i class="fa fa-cubes"></i></button>
												</form>
											</td>
										</tr>
										';
				...
				<div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            ...
                            <h3 class="box-title">Ordenes en Bodega</h3>
                            <div class="table-responsive">
                             ';	

							$sql1="SELECT * FROM ordenes WHERE estado='EN BODEGA' ORDER BY codigo DESC";
							$sql2=mysqli_query($conexion, $sql1);
